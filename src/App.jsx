...
const MENU_ITEMS = [
  ...
  // CREPES
  { id:8,  name:"Crepa Nutella/Banana",  cat:"Crepes",  price:8.00, emoji:"🥞", stock:20,  desc:"Flour, eggs, milk, butter · Nutella, banana, whipped cream" },
  { id:9,  name:"Crepa Fresa/Nutella",  cat:"Crepes",  price:8.00, emoji:"🍓", stock:20,  desc:"Flour, eggs, milk, butter · strawberry syrup, Nutella, whipped cream" },
  { id:10, name:"Crepa Ham and Cheese", cat:"Crepes",  price:8.00, emoji:"🧀", stock:20,  desc:"Flour, eggs, milk, butter · ham, shredded cheese, sour cream" },
  { id:20, name:"Crepa Banana/Nutella", cat:"Crepes",  price:8.00, emoji:"🍌", stock:20,  desc:"Flour, eggs, milk, butter · Nutella, banana, whipped cream" },
  // DRINKS
